...
typedef enum {
	...
	CDX_CMD_GET_AUDIO_CHANNEL,

	CDX_CMD_GET_SUB_INFO,//yf
	CDX_CMD_GET_AUDIO_INFO,//yf
	CDX_CMD_GETAUDIOCOUNT,
	CDX_CMD_NULL
}CEDARX_COMMAND_TYPE;
...
typedef enum CEDARX_EVENT_TYPE{
    ...
    CDX_MEDIA_BUFFERING_PRECENT     =65,//yf
...
typedef struct tag_CDXPrepareDoneInfo
{
    int ret;
    int _3d_mode_double_stream_flag;   //CEDARV_3D_MODE_DOUBLE_STREAM, 1:double_stream, 0: single stream.
}CDXPrepareDoneInfo;
